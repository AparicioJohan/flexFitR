...
In this example, we have 196 plots but will only fit the model for plots 195 and 40 as a subset. We define the piecewise function `fn_piwise` and set initial values for the parameters.
